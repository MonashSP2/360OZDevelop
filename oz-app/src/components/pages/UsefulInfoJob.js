...
const UsefulInfoPhone =()=>{
    return (
      <div>
        ...
        <p>
            As an international student, you are allowed to work 20 hours per week once your course has started. There are a large number of job search and career development resources in Australia. You can look for jobs across different industries of your preference in which you can apply for online.</p>
