                            ...
                            <div>
                                ...
                                <div style={{marginLeft: '-500px', marginTop: '100px'}}>{returnPoints.map(item => (
                                    <li id='locationContainer' key={item.id}>{
                                        ...
                                        <a id="googleExternal" target="_blank" rel="noopener noreferrer"
                                ...
                                <div style={{marginLeft: '-500px', marginTop: '90px'}}>
                                    <li id='allLocationContainer'> Navigate to All (Day 1)
                                        <a id="allGoogleExternal" target="_blank" rel="noopener noreferrer"
                                           href={'https://www.google.com/maps/dir/' + day1Coordinates}>
                                        </a>
                                    </li>
                            ...
                            <div>
                                ...
                                <div style={{marginLeft: '-500px', marginTop: '90px'}}>
                                    <li id='allLocationContainer'> Navigate to All (Day 2)
                                        <a id="allGoogleExternal" target="_blank" rel="noopener noreferrer"
                                           href={'https://www.google.com/maps/dir/' + day2Coordinates}>
                                        </a>
                                    </li>
                            ...
                            <div>
                                ...
                                <div style={{marginLeft: '-500px', marginTop: '90px'}}>
                                    <li id='allLocationContainer'> Navigate to All (Day 3)
                                        <a id="allGoogleExternal" target="_blank" rel="noopener noreferrer"
                                           href={'https://www.google.com/maps/dir/' + day3Coordinates}>
                                        </a>
                                    </li>
